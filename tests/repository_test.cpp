...
int main() {
  ...
  joggle::Diag second_parse_diagnostics;
  ...
  joggle::Diag duplicate_bundle_diagnostics;
  ...
  joggle::Diag install_diagnostics;
  ...
  joggle::Diag visible_diagnostics;
  const auto visible =
  ...
  joggle::Diag second_install_diagnostics;
  ...
  if (installed) {
    ...
    joggle::Diag reinstall_diagnostics;
    ...
    joggle::Diag remove_diagnostics;
    ok &=
    ...
    joggle::Diag remaining_diagnostics;
    ...
    joggle::Diag missing_remove_diagnostics;
    ...
    joggle::Diag corrupt_data_diagnostics;
    const auto corrupt =
    ...
    joggle::Diag corrupt_reinstall_diagnostics;
