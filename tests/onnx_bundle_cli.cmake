foreach(required JOGGLE_CLI JOGGLE_ARITH_MOD JOGGLE_TENSOR_MOD JOGGLE_NN_MOD
                 JOGGLE_QUANT_MOD JOGGLE_ONNX_MOD JOGGLE_ONNX_NATIVE
                 JOGGLE_ONNX_MODEL JOGGLE_BUNDLE_TEST_DIR)
...
set(with_mods --with "${JOGGLE_ARITH_MOD}")
list(APPEND with_mods --with "${JOGGLE_TENSOR_MOD}")
list(APPEND with_mods --with "${JOGGLE_NN_MOD}")
...
foreach(dependency IN ITEMS JOGGLE_ARITH_MOD JOGGLE_TENSOR_MOD JOGGLE_NN_MOD
                            JOGGLE_QUANT_MOD JOGGLE_ONNX_MOD)
  expect_success("install ${dependency}"
    "${JOGGLE_CLI}" install "${${dependency}}" --root "${root}")
endforeach()
...
string(FIND "${lock_text}" "mod arith@2.2.0#" arith_position)
string(FIND "${lock_text}" "mod tensor@8.0.0#" tensor_position)
string(FIND "${lock_text}" "mod nn@3.2.0#" nn_position)
