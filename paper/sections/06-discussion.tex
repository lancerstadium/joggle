...
\paragraph{Progressive structure.}
...
repeated setup while preserving interpreted execution. Typed mod bindings
provide native acceleration for selected functions through the same call
boundary.
