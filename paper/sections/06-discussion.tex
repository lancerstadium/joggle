...
result. Whole-graph traversal correctly creates a broad dependency; direct
lookup creates a narrow one. State outside the graph enters through typed
arguments or the environment. These rules make the reuse boundary inspectable:
miss reasons and observation counts show why a stage ran.
