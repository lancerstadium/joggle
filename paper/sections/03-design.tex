...
changed. The \texttt{Mod} argument gives \texttt{select} access to the subject
under a mutating run, whereas \texttt{supports} only inspects an owned
\texttt{Ty} value. Body-less \texttt{sim} and \texttt{emit} declarations bind
