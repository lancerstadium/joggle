...
\begin{figure}[t]
  \centering
  \includegraphics[width=.80\columnwidth]{figures/figure-03-call-model.png}
...
\begin{lstlisting}[language=jog,float=t,caption={The \texttt{sat} mod defines semantics,
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.80\columnwidth]{figures/figure-04-dependencies.png}
