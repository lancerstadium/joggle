...
exposes schedules, and TVM exposes graph and tensor-program
optimization~\cite{lattner2004llvm,lattner2021mlir,ragankelley2012halide,chen2018tvm}.
The difficulty is that a complete feature combines several of these roles,
while their declarations, composition boundaries, and invalidation rules
remain separate.
