...
Figure~\ref{fig:thesis-map} connects each development problem to a Joggle
mechanism and its evaluation endpoint. Extension tasks measure executable
completion and agent effort; paired patches measure change footprint;
controlled edits measure update latency and executed work. Together, these
comparisons link the extension interface, ownership boundary, and execution
model to their effects on compiler development.
