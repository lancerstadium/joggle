...
For the pinned operator configuration in Appendix~\ref{sec:operator-data},
all 24 operators pass the numerical oracle in both Joggle paths. The
optimization pack reduces geometric mean latency by $1.81\times$ relative to
