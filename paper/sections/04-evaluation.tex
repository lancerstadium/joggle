...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{0.22\columnwidth}p{0.70\columnwidth}@{}}
    ...
    Reactive & 15 models, generated graphs, four policies; latency, work, and reuse \\
...
extension path from a pinned revision. The model corpus contains 15
...
results but never contributes a latency or speedup. Latency cases run ten
warm-ups followed by 100 measurements in a seeded random order. We report
