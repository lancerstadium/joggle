...
As a supplementary interface-predictability diagnostic, we also report the
...
inference and conversion, \texttt{c.prepare}, storage planning, and C emission,
together with graph size, emitted bytes, and artifact correctness. These full
path measurements do not enter \(
