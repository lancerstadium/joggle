...
#ifndef ONNX_MLIR_POLICY_ACCELERATOR_H
#define ONNX_MLIR_POLICY_ACCELERATOR_H

#include "src/Accelerators/Accelerator.hpp"

namespace onnx_mlir::accel {

class PolicyAccelerator final : public Accelerator {
public:
  static PolicyAccelerator *getInstance();

  static bool classof(const Accelerator *accelerator) {
    return accelerator->getKind() == Accelerator::Kind::Policy;
  }
  static bool classof(const PolicyAccelerator *) { return true; }
