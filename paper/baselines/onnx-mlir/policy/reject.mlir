module attributes {llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32", llvm.target_triple = "arm64-apple-darwin24.6.0", "onnx-mlir.accels" = ["Policy-0x100"], "onnx-mlir.compile_options" = "--maccel=Policy --O0 --EmitMLIR --policy-call-weight=4 --policy-other-weight=1 --policy-max-extent=0 --policy-max-calls=100 --policy-report -o reject model.onnx", "onnx-mlir.compiler_version" = "onnx-mlir version 0.4.2 (4a13c34a)", "onnx-mlir.op_stats" = "{\0A  \22func.return.1D\22 : 1,\0A  \22onnx.Add.1D.1D\22 : 3\0A}\0A", "onnx-mlir.symbol-postfix" = "reject"} {
  func.func @main_graph(%arg0: memref<4xf32> {onnx.name = "a"}, %arg1: memref<4xf32> {onnx.name = "b"}, %arg2: memref<4xf32> {onnx.name = "c"}, %arg3: memref<4xf32> {onnx.name = "d"}) -> (memref<4xf32> {onnx.name = "result"}) attributes {llvm.emit_c_interface} {
    ...
    affine.for %arg4 = 0 to 4 {
      ...
      affine.store %2, %alloc[%arg4] : memref<4xf32>
    }
    %alloc_0 = memref.alloc() {alignment = 16 : i64} : memref<4xf32>
    affine.for %arg4 = 0 to 4 {
      %0 = affine.load %alloc[%arg4] : memref<4xf32>
      %1 = affine.load %arg2[%arg4] : memref<4xf32>
      %2 = arith.addf %0, %1 : f32
      affine.store %2, %alloc_0[%arg4] : memref<4xf32>
    }
    %alloc_1 = memref.alloc() {alignment = 16 : i64} : memref<4xf32>
    affine.for %arg4 = 0 to 4 {
      %0 = affine.load %alloc_0[%arg4] : memref<4xf32>
      %1 = affine.load %arg3[%arg4] : memref<4xf32>
      %2 = arith.addf %0, %1 : f32
      affine.store %2, %alloc_1[%arg4] : memref<4xf32>
    }
    return %alloc_1 : memref<4xf32>
  }
