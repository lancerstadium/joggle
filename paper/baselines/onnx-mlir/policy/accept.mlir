module attributes {llvm.data_layout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32", llvm.target_triple = "arm64-apple-darwin24.6.0", "onnx-mlir.accels" = ["Policy-0x100"], "onnx-mlir.compile_options" = "--maccel=Policy --O0 --EmitMLIR --policy-call-weight=4 --policy-other-weight=1 --policy-max-extent=100 --policy-max-calls=100 --policy-report -o accept model.onnx", "onnx-mlir.compiler_version" = "onnx-mlir version 0.4.2 (4a13c34a)", "onnx-mlir.op_stats" = "{\0A  \22func.return.1D\22 : 1,\0A  \22onnx.Add.1D.1D\22 : 3\0A}\0A", "onnx-mlir.symbol-postfix" = "accept"} {
