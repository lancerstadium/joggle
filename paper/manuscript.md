...
[TVM's](https://www.usenix.org/conference/osdi18/presentation/chen) own
...
[Relax](https://arxiv.org/abs/2311.02103) lets high-level functions, TensorIR functions, and external calls coexist
...
[Exo](https://doi.org/10.1145/3519939.3523446) externalizes
...
This design separates **mechanism generality** from **implementation maturity**.
...
### 5.1 RQ1: Does progressive exposure survive real models?
...
### 5.2 RQ2: How cheaply can a vertical extension be created and revised?
