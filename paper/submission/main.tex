...
\acmYear{2027}
\title[Joggle: Malleable Inference Compilation]{Joggle: Malleable Inference Compilation with a Progressive Function IR}
...
\nolinkurl{Fn}/\nolinkurl{Blk}/\nolinkurl{Op}/\nolinkurl{Val} objects. Decoders, analyses, transformations, planners,
...
\begin{enumerate}
\item
A function-oriented compiler design that progressively exposes conventional
neural-network models from schema calls to structured loop bodies without a
mandatory representation boundary.

\item
A source module mechanism in which frontend bridges, semantic
...
\item
An empirical evaluation of extension surface, composition failure,
