...
\acmYear{2027}
\title[Joggle: Typed Modules]{Joggle: Distributable Typed Modules Across the Compiler Stack}
...
mechanisms. This \textbf{role fragmentation} affects more than new hardware: it also
appears in experimental datatypes, analyses, external tools, generated
policies, validators, and artifact formats. Joggle explores \textbf{typed modules} as one distributable extension unit across
...
Joggle starts from a different observation: \textbf{cross-role decisions often share
...
\begin{enumerate}
\item
\textbf{A distributable typed-module extension model} that hosts vocabulary,
...
\section{Motivation: one extension crosses several compiler roles}
