...
\begin{itemize}
\item
\textbf{RQ1, progressive representation:} Can imported model calls, reusable
...
\item
\textbf{RQ2, extension surface:} Across an end-to-end ONNX-MLIR baseline and
...
\item
\textbf{RQ3, composition:} Do independently defined modules compose with stable
output, transactional failure, and useful unsupported-frontier diagnostics?

\item
\textbf{RQ4, artifact quality:} Under matched model, threading, and correctness
