...
\acmYear{2027}
\title[Joggle: Distributable Extensions]{Joggle: Distributable Compiler Extensions for Agile Inference Co-Design}
...
co-design, that boundary is itself an experimental variable. Joggle is a lightweight compiler substrate for this period of change. Its
\textbf{progressive exposure} mechanism preserves one typed program while modules
