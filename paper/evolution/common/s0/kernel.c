...
void evolution_conv(const float* x, const float* weight,
                    int64_t batch, int64_t height, int64_t width,
                    int64_t outputs, int64_t group_channels,
                    ...
                    int64_t groups, int64_t x_n_stride,
                    int64_t x_c_stride, int64_t x_h_stride,
                    int64_t x_w_stride, int64_t weight_m_stride,
                    int64_t weight_q_stride, int64_t weight_r_stride,
                    int64_t weight_s_stride, int64_t out_n_stride,
                    int64_t out_m_stride, int64_t out_h_stride,
                    int64_t out_w_stride, float* out) {
