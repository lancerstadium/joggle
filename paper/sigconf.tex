...
and operator- and model-level artifact measurements. These measurements connect
extension predictability to executable completion, feature ownership to patch
footprint, and affected graph scope to update cost.
\end{abstract}
