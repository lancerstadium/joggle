...
`arith@1.0.0` is the scalar-computation boundary used by domain libraries.
...
These generic declarations make the current tensor-calculus slice independent
of one fixed scalar format. A format Mod may provide more specific overloads.
